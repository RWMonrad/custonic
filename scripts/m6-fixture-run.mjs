...
async function verifyResults(analysis) {
  ...
  try {
    ...
    if (findings.length === 0) {
      console.log(`⚠️ No findings generated - this might be expected for simple contracts`)
    }
    ...
    console.log(`📎 ${findingsWithCitations}/${findings.length} findings have citations`)
