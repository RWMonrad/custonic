...
export function ContractAnalysis({ contract }: ContractAnalysisProps) {
  ...
  const canAnalyze = ["active", "completed", "failed"].includes(
    contract.status,
  );
  ...
  return (
    <div className="bg-white rounded-lg border p-6">
        ...
        {analysisStatus.status === "failed" && (
          <div>
            ...
            <form action={enqueueFormAction}>
              ...
              />
              <SubmitButton variant="secondary">Retry Analysis</SubmitButton>
            </form>
          </div>
        )}
      </div>
      ...
      <div className="mt-6 text-xs text-gray-500">
        <p>
          Analysis automatically identifies potential risks and compliance
          issues in your contracts.
        </p>
