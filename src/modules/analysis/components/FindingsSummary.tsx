  ...
  return (
    <div className="mb-6 p-4 bg-gray-50 rounded-lg">
      ...
      {topCriticalFindings.length > 0 && (
        <div>
          <h5 className="text-xs font-medium text-gray-700 mb-2">Top Priority Issues</h5>
      ...
      <div className="mt-4 pt-3 border-t border-gray-200">
        <p className="text-xs text-gray-600">
          ...
          {criticalCount === 0 && highCount > 0 && ` ${highCount} high-risk issue${highCount > 1 ? 's' : ''} should be reviewed soon.`}
          {criticalCount === 0 && highCount === 0 && totalFindings > 0 && ' All findings are low to medium risk.'}
        </p>
      </div>
    </div>
  )
